CREATE OR REPLACE VIEW getCustomer_info03 AS
...
WHERE A.COUNTRY_CODE = "US" AND A.BUDGET <= 4000000 GROUP BY A.CUSTOMER_ID ORDER BY
A.USED DESC;


SELECT * FROM `getCustomer_info03`;